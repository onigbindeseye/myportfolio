...
export const portfolio = [
  ...
  },
  {
    ...
    description:
      'Active Citizen Award is BudgIT’s initiative and signature move to spotlight and appreciate personalities, organisations and agencies doing these ground-breaking humanitarian work in Nigeria. They believe that the ACA will stir more conversations on the need to recognise the tremendous contributions of our civic leaders to effective governance and an active civic space in Nigeria.',
    stack1: 'React',
    stack2: 'Material-UI',
    github: 'http://github.com/',
